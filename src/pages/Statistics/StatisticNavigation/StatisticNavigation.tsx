...
export const StatisticNavigation: FC = () => {
    ...
    <div className="page-content__wrap">
      <section className="page-content__global-earnings global-earnings">
        <Link
          ...
          className={`${
            pathname.match('/statistics/referrals_program')
              ? 'link-active'
        ...
        <Link
          ...
          className={`${
            pathname.match('/statistics/rewards_program')
              ? 'link-active'
              : 'global-earnings__btn'
          }`}
        >
        ...
        <NavLink
          to={`${url}/rentpayments`}
          className={`${
            pathname.match('/statistics/rentpayments')
              ? 'link-active'
              : 'global-earnings__btn'
          }`}
        >
        ...
        <Link
          to={`${url}/cashbacks`}
          className={`${
            pathname.match('/statistics/cashbacks')
              ? 'link-active'
              : 'global-earnings__btn'
          }`}
        >
        ...
        <Link
          to={`${url}/statistic`}
          className={`${
            pathname.match('/statistics/statistic')
              ? 'link-active'
              : 'global-earnings__btn'
          }`}
        >
